      ...
      <div className={style.mainDiv}>
        ...
        <div className={style.Main_Div_Inside_Div}>
          ...
          <div className={style.Personal_Coach_Mode_Section}>
            ...
            <h1 className={style.Personal_Coach_Mode_Section_H1_Heading}>Personal Coach Mode</h1>
          ...
          <div className={style.LowerTimeSpentSection}>
            <div>
              ...
              <p className={style.LowerTimeSpent_P_Tag}>Quickly and efficiently coach clients via JEFIT allowing you to expand your client base without increasing your time invested.</p>

              <h4 className={style.LowerTimeSpent_H4_tag}>Easily Build and Sell Workout Plans</h4>
              <p className={style.LowerTimeSpent_P_Tag}>Develop and distribute your premium workout plan with JEFIT’s robust exercise and workout plan libraries</p>
          ...
          <div className={style.Client_Management_section}>
            ...
            <div>
              <h1 className={style.Client_Management_section_H1_tag_Head}>Client Management</h1>

              <h2 className={style.Client_Management_section_H2_tag_Head}>Coach More Clients in Less Time</h2>

              <p className={style.Client_Management_section_P_Tag_Des}>· Easily onboard new clients with JEFIT's robust online routine building and distribution system.</p>
              <p className={style.Client_Management_section_P_Tag_Des}>· JEFIT's premium exercise library coaches clients during their workout with exercise instructions and HD video demonstrations.</p>
          ...
          <div className={style.Premium_Workout_Plans_section}>
            ...
            <div>
              ...
              <h1 className={style.Premium_Workout_Plans_section_H1_tag_Head}>Premium Workout Plans</h1>
          ...
          <div className={style.Client_Management_section}>
            ...
            <div>
              <h1 className={style.Client_Management_section_H1_tag_Head}>Coach Branding</h1>

              <h2 className={style.Client_Management_section_H2_tag_Head}>Build a reputation & let new clients come to you.</h2>

              <p className={style.Client_Management_section_P_Tag_Des}>· Be one of the first Coaches on JEFIT and start building your reputation first</p>
              <p className={style.Client_Management_section_P_Tag_Des}>· Find time efficient clients as JEFIT users require less coaching than your average client.</p>
          ...
          <div className={style.start_YouFree_Trial_section}>
            ...
            <div>
              ...
              <h1 className={style.start_YouFree_Trial_section_h1_tag}>Start Your Free Trial</h1>

              <h2 className={style.start_YouFree_Trial_section_h2_tag}>After the free trial,</h2>

              <p className={style.start_YouFree_Trial_section_p_tag}><CalendarIcon w={6} h={8} color='#808285;' />  .  $19.99/month</p>
              <p className={style.start_YouFree_Trial_section_p_tag}><SettingsIcon w={6} h={8} color='#808285;' />  .  You decide what to charge your clients and keep the rest!</p>
              <br />
              ...
              <Link to="./login"> <button className={style.Client_Management_section_Button_Start_explore}>START EXPLORING</button> </Link>
          ...
          <div className={style.our_goal_is_to_Help_Section}>
            ...
            <h1 className={style.our_goal_is_to_Help_Section_h1_tag}>Our Goal Is To Help You Succeed</h1>

            <p className={style.our_goal_is_to_Help_Section_p_tag}>Contact us at product@jefit.com for any questions or feedback</p>
