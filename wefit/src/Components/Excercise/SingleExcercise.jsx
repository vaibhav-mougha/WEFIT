            ...
            <Flex flexDirection="column">
                  ...
                  {data.image_urls &&
                    data.image_urls.map((el, i) => (
                      <Box key={data.id} border="5px solid rgb(0, 174, 239)">
                        ...
                        <Text fontSize="11px" textAlign="center">Click to Enlarge</Text>
                      </Box>
                    ))}
                  {/* <Box border="10px solid rgb(0, 174, 239)">
                                  <Text>2</Text>
                                  <Image  src={data[0] && data[0].image_urls[1]}/>
              ...
              >
                ...
                >
                  ...
                  <Text>The {data.name} is a basic {data.main_group} exercise that helps increase the size of the muscles.</Text>
                  <Text>Steps :</Text>
                  <Text>
