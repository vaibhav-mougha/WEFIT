            ...
            <>
              <div key={el.id} className={style.blog_Img_Main_section}>
                <div>
                  ...
                  <Link to={`/blog/${el.id}`} style={{ textDecoration: 'none' }}><h1 className={style.blog_Img_Main_section_Title_h2_tag}>{el.title}</h1></Link>
                  <h4 className={style.blog_Img_Main_section_MiniTitle_h4_tag}>{el.miniTitle}</h4>

                  <p className={style.blog_Img_Main_section_P_tag_description}>{el.description}</p>

                  <Link to={`/blog/${el.id}`} ><Text className={style.blog_Img_Main_section_Read_MOre_Link}>Read More{">>"}</Text></Link>
                </div>
              </div>
            </>
          ))
